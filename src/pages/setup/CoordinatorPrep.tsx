...
function buildRows(p: PrepState, schoolName?: string): PrepRow[] {
  return [
    { question: 'School name', answer: schoolName, field: 'school_name' },
    { question: 'School site URL', answer: p.school_site_url, field: 'school_site_url' },
    { question: 'District calendar URL', answer: p.district_calendar_url, field: 'district_calendar_url' },
    { question: 'Weekly early-release day', answer: p.early_release_day || 'None', field: 'early_release_day' },
    { question: 'Early-release end time', answer: p.early_release_end_time, field: 'early_release_end_time' },
    { question: 'Teacher union link', answer: p.teacher_union_url, field: 'teacher_union_url' },
    { question: 'Teacher contract link', answer: p.teacher_contract_url, field: 'teacher_contract_url' },
    { question: 'Specialist scheduling style', answer: schedulingStyleLabel(p.grade_preference), field: 'grade_preference' },
    { question: 'How many specialist teachers?', answer: p.specialist_count == null ? '' : String(p.specialist_count), field: 'specialist_count' },
    { question: 'Specialists using a teaching cart', answer: p.cart_users, field: 'cart_users' },
    { question: 'Specialists at two schools', answer: p.two_school_users, field: 'two_school_users' },
    { question: 'Part-time specialists (with days)', answer: p.part_time_users, field: 'part_time_users' },
    { question: 'Specialists with custom grade preferences', answer: p.custom_grade_prefs, field: 'custom_grade_prefs' },
